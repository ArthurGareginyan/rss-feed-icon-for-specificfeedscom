...
function specificfeedsicon_settings_link( $links ) {
	$settings_page = '<a href="' . admin_url( 'options-general.php?page=settings_page.php' ) .'">' . __( 'Settings', 'specificfeedsicon' ) . '</a>';
...
function specificfeedsicon_menu() {
	add_options_page('SpecificFeeds', 'SpecificFeeds', 'manage_options', 'settings_page.php', 'specificfeedsicon_render_submenu_page');
}
