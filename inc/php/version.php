 ...
 * @since 4.2
 */
function specificfeedsicon_plugin_version_number() {
    ...
    if ( $new_number == $current_number ) {
        ...
        if ( $info['old_version'] == '1' ) {
            ...
            $info['old_version'] = '0';
            update_option( RFIFS_SETTINGS . '_service_info', $info );
...
specificfeedsicon_plugin_version_number();
