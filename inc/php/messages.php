            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <img src="<?php echo RFIFS_URL . 'inc/img/avatar.png'; ?>">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <p><?php _e( 'Hello. I\'m Arthur, the author of this plugin.', RFIFS_TEXT ); ?></p>
                        <p><?php printf(
                                        __( 'Thank you for installing my plugin! I hope you will love it! %s', RFIFS_TEXT ),
                                        '&#x1F603;'
                                        );
                            ?></p>
                    </div>
 ...
 * @since 4.3
 */
function specificfeedsicon_error_message() {

    $info = get_option( RFIFS_SETTINGS . '_service_info' );
    ...
    ?>
        <div id="error-message" class="modal fade error-message" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <p><?php _e( 'You have installed an old version of this plugin.', RFIFS_TEXT ); ?></p>
                        <p><?php _e( 'Please update the plugin to the latest version, and all will be fine.', RFIFS_TEXT ); ?></p>
                    </div>
                </div>
            </div>
        </div>
