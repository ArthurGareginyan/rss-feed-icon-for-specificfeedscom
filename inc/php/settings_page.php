...
function specificfeedsicon_render_submenu_page() {
	...
	<div class="wrap">
		<h2>
            ...
            <br/>
            <span>
                <?php _e( 'by <a href="http://www.arthurgareginyan.com" target="_blank">Arthur Gareginyan</a>', 'rss-feed-icon-for-specificfeedscom' ); ?>
            <span/>
		</h2>
            ...
            <div class="inner-sidebar">
                <div id="side-sortables" class="meta-box-sortabless ui-sortable">
                    ...
                    <div id="help" class="postbox">
                        ...
                        <div class="inside">
                            <p><?php _e( 'Got something to say? Need help?', 'rss-feed-icon-for-specificfeedscom' ); ?></p>
                    ...
                    <div id="donate" class="postbox">
                        ...
                        <div class="inside">
                            <p><?php _e( 'If you like this plugin and find it useful, please help me to make this plugin even better and keep it up-to-date.', 'rss-feed-icon-for-specificfeedscom' ); ?></p>
                    ...
                    <div id="advertisement" class="postbox">
                        <h3 class="title"><?php _e( 'Advertisement', 'rss-feed-icon-for-specificfeedscom' ); ?></h3>
                        <div class="inside">
